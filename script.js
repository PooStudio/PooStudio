// === Floating 3D Poop Background - Fully Self-Contained JS ===
// Just include this script once on your page and it works.
...
(() => {
    ...
    window.addEventListener('load', () => {
        ...
        function initPoop() {
            ...
            container.id = 'floating-poop-container';
            document.body.appendChild(container);

            // Inject CSS
            const style = document.createElement('style');
            style.textContent = `
                #floating-poop-container {
                ...
                #floating-poop-container canvas {
                    position: absolute;
                    top: 0; left: 0;
                    width: 100%; height: 100%;
                }
                #floating-poop-container:hover {
                    pointer-events: auto;
                }
            `;
